...
function get_pages() {
	return array(
		array(
			'step'      => 1,
			'stepTitle' => esc_html__( 'Use of WordPress', 'wporg' ),
		...
		array(
			'step'      => 2,
			'stepTitle' => esc_html__( 'Passionate', 'wporg' ),
			'headline'  => esc_html__( 'What are you passionate about?', 'wporg' ),
			'questions' => array(
				array(
					'label' => esc_html__( 'Web development, backend development etc.', 'wporg' ),
					'teams' => array(
						'support',
						'core',
						'themes',
				...
				array(
					'label' => esc_html__( 'Writing tests, support codebase for WordPress.org', 'wporg' ),
					'teams' => array(
						'meta',
						'tide',
						'cli',
				...
				array(
					'label' => esc_html__( 'Helping others', 'wporg' ),
					'teams' => array(
						'support',
						'training',
					),
				...
				array(
					'label' => esc_html__( 'Mobile apps', 'wporg' ),
					'teams' => array(
						'mobile',
					),
				),
				array(
					'label' => esc_html__( 'Documentation', 'wporg' ),
					'teams' => array(
						'core',
						'meta',
						'documentation',
				...
				array(
					'label' => esc_html__( 'Testing', 'wporg' ),
					'teams' => array(
						'core',
						'documentation',
						'tide',
				...
				array(
					'label' => esc_html__( 'Web design', 'wporg' ),
					'teams' => array(
						'design',
					),
				),
				array(
					'label' => esc_html__( 'Content creation', 'wporg' ),
					'teams' => array(
						'support',
						'polyglots',
						'training',
				...
				array(
					'label' => esc_html__( 'Marketing', 'wporg' ),
					'teams' => array(
						'marketing',
					),
				),
				array(
					'label' => esc_html__( 'Organising a meetup and helping the community', 'wporg' ),
					'teams' => array(
						'community',
					),
				),
				array(
					'label' => esc_html__( 'Translation', 'wporg' ),
					'teams' => array(
						'polyglots',
					),
				),
				array(
					'label' => esc_html__( 'Accessibility', 'wporg' ),
					'teams' => array(
						'accessibility',
					),
				),
		...
		array(
			'step'      => 3,
			'stepTitle' => esc_html__( 'Experience', 'wporg' ),
			'headline'  => esc_html__( 'Are these areas you have experience with or are eager to try?', 'wporg' ),
			'questions' => array(
				array(
					'label' => esc_html__( 'Q&A, helping others use programmes, support', 'wporg' ),
					'teams' => array(
						'support',
					),
				),
				array(
					'label' => esc_html__( 'Organizing events, groups, etc.', 'wporg' ),
					'teams' => array(
						'community',
					),
				),
				array(
					'label' => esc_html__( 'Writing translations', 'wporg' ),
					'teams' => array(
						'polyglots',
					),
				),
				array(
					'label' => esc_html__( 'Teaching others', 'wporg' ),
					'teams' => array(
						'training',
					),
				),
				...
				array(
					'label' => esc_html__( 'Photography, video recording or processing', 'wporg' ),
					'teams' => array(
						'tv',
					),
				),
				array(
					'label' => esc_html__( 'Writing code, fixing bugs, writing developer documentation etc.', 'wporg' ),
					'teams' => array(
						'core',
						'meta',
						'cli',
				...
				array(
					'label' => esc_html__( 'Creating or editing WordPress themes', 'wporg' ),
					'teams' => array(
						'themes',
					),
				),
				array(
					'label' => esc_html__( 'Creating or editing WordPress plugins', 'wporg' ),
					'teams' => array(
						'plugins',
					),
				),
				array(
					'label' => esc_html__( 'Writing content, creating documentation for projects or software', 'wporg' ),
					'teams' => array(
						'documentation',
					),
				),
				array(
					'label' => esc_html__( 'Web design, UX or UI design', 'wporg' ),
					'teams' => array(
						'design',
					),
				),
				array(
					'label' => esc_html__( 'Mobile apps development or design', 'wporg' ),
					'teams' => array(
						'mobile',
					),
				),
				array(
					'label' => esc_html__( 'Implementing accessibility standards', 'wporg' ),
					'teams' => array(
						'accessibility',
					),
				),
				array(
					'label' => esc_html__( 'Writing automated tests', 'wporg' ),
					'teams' => array(
						'tide',
						'cli',
					),
		...
		array(
			'step'      => 4,
			'stepTitle' => esc_html__( 'Done!', 'wporg' ),
			'headline'  => esc_html__( 'Based on your answers, we recommend that you join some of the teams below.', 'wporg' ),
			'questions' => false,
		),
	);
}
...
function get_teams() {
	return array(
		'support' => array(
			'name'          => esc_html__( 'Support', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Support »', 'wporg' ),
			'description'   => esc_html__( 'Answering a question in the support forums or IRC is one of the easiest ways to start contributing. Everyone knows the answer to something!', 'wporg' ),
		...
		'community' => array(
			'name'          => esc_html__( 'Community', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Community »', 'wporg' ),
			'description'   => esc_html__( 'If you’re interested in organizing a meetup or a WordCamp, the community blog is a great place to get started. There are groups working to support events, to create outreach and training programs, and generally support the community.', 'wporg' ),
		...
		'polyglots' => array(
			'name'          => esc_html__( 'Polyglots', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Polyglots »', 'wporg' ),
			'description'   => esc_html__( 'WordPress is used all over the world and in many different languages. If you’re a polyglot, help out by translating WordPress into your own language. You can also assist with creating the tools that make translations easier.', 'wporg' ),
		...
		'training' => array(
			'name'          => esc_html__( 'Training', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Training »', 'wporg' ),
			'description'   => esc_html__( 'The training team creates downloadable lesson plans and related materials for instructors to use in a live workshop environment. If you enjoy teaching people how to use and build stuff for WordPress, immediately stop what you’re doing and join our team!', 'wporg' ),
		...
		'marketing' => array(
			'name'          => esc_html__( 'Marketing', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Marketing »', 'wporg' ),
			'description'   => esc_html__( 'Our vision for the Marketing Team is to be the go-to resource for strategy and content for other WordPress teams.', 'wporg' ),
		...
		'tv' => array(
			'name'          => esc_html__( 'TV', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about TV »', 'wporg' ),
		...
		'core' => array(
			'name'          => esc_html__( 'Core', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Core »', 'wporg' ),
		...
		'meta' => array(
			'name'          => esc_html__( 'Meta', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Meta »', 'wporg' ),
		...
		'themes' => array(
			'name'          => esc_html__( 'Themes', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Themes »', 'wporg' ),
		...
		'plugins' => array(
			'name'          => esc_html__( 'Plugins', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Plugins »', 'wporg' ),
		...
		'documentation' => array(
			'name'          => esc_html__( 'Documentation', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Documentation »', 'wporg' ),
			'description'   => esc_html__( 'Good documentation lets people help themselves when they get stuck. The docs team is responsible for creating documentation and is always on the look-out for writers.', 'wporg' ),
		...
		'design'        => array(
			'name'          => esc_html__( 'Design', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Design »', 'wporg' ),
			'description'   => esc_html__( 'The design group is focused on the designing and developing the user interface. It’s a home for designers and UXers alike. There are regular discussions about mockups, design, and user testing.', 'wporg' ),
		...
		'mobile'        => array(
			'name'          => esc_html__( 'Mobile', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Mobile »', 'wporg' ),
			'description'   => esc_html__( 'The mobile team builds the iOS and Android apps. Lend them your Java, Objective-C, or Swift skills. The team also needs designers, UX experts, and testers to give users an smooth experience on every device.', 'wporg' ),
		...
		'accessibility' => array(
			'name'          => esc_html__( 'Accessibility', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Accessibility »', 'wporg' ),
			'description'   => esc_html__( 'The a11y group provides accessibility expertise across the project. They make sure that WordPress core and all of WordPress’ resources are accessible.', 'wporg' ),
		...
		'tide' => array(
			'name'          => esc_html__( 'Tide', 'wporg' ),
			'learnMore'     => esc_html__( 'Learn more about Tide »', 'wporg' ),
			'description'   => esc_html__( 'Tide is a series of automated tests run against every plugin and theme in the directory and then displays PHP compatibility and test errors/warnings in the directory.', 'wporg' ),
		...
		'cli' => array(
			...
			'learnMore'     => esc_html__( 'Learn more about CLI »', 'wporg' ),
			'description'   => esc_html__( 'WP-CLI is the official command line tool for interacting with and managing your WordPress sites.', 'wporg' ),
			'icon'          => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><rect x="0" fill="none" width="20" height="20"/><g><path d="M17 7.2V3H3v7.1c2.6-.5 4.5-1.5 6.4-2.6.2-.2.4-.3.6-.5v3c-1.9 1.1-4 2.2-7 2.8V17h14V9.9c-2.6.5-4.4 1.5-6.2 2.6-.3.1-.5.3-.8.4V10c2-1.1 4-2.2 7-2.8z"/></g></svg>',

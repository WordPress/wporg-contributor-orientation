	...
	return array(
		...
		array(
			...
			'questions' => array(
				...
				array(
					'label' => esc_html__( 'Creating graphics, designing layouts, editing videos', 'wporg' ),
					'teams' => array(
						'design',
						'training',
					),
		...
		array(
			...
			'questions' => array(
				...
				array(
					'label' => esc_html__( 'Mobile apps development, design, or documentation', 'wporg' ),
					'teams' => array(
						'mobile',
						'design',
					),
...
function get_teams() {
	return array(
		'support' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Support »', 'wporg' ),
		...
		'community' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Community »', 'wporg' ),
		...
		'polyglots' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Polyglots »', 'wporg' ),
		...
		'training' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Training »', 'wporg' ),
		...
		'marketing' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Marketing »', 'wporg' ),
		...
		'tv' => array(
			...
			'learnMore'     => esc_html__( 'Get started with TV »', 'wporg' ),
		...
		'core' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Core »', 'wporg' ),
		...
		'meta' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Meta »', 'wporg' ),
		...
		'themes' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Themes »', 'wporg' ),
		...
		'plugins' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Plugins »', 'wporg' ),
		...
		'documentation' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Documentation »', 'wporg' ),
		...
		'design'        => array(
			...
			'learnMore'     => esc_html__( 'Get started with Design »', 'wporg' ),
		...
		'mobile'        => array(
			...
			'learnMore'     => esc_html__( 'Get started with Mobile »', 'wporg' ),
		...
		'accessibility' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Accessibility »', 'wporg' ),
		...
		'tide' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Tide »', 'wporg' ),
		...
		'cli' => array(
			...
			'learnMore'     => esc_html__( 'Get started with CLI »', 'wporg' ),
		...
		'photos' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Photos »', 'wporg' ),
		...
		'core-performance' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Core Performance »', 'wporg' ),
		...
		'test' => array(
			...
			'learnMore'     => esc_html__( 'Get started with Test »', 'wporg' ),
